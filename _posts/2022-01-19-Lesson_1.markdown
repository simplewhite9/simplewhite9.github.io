...
description: Introduction and Word Vectors
...
<span class="highlight-red bold">NOTE</span>: 사실 이와 같은 방법으로 진행했을때의 two model variants

(1)CBOW(Continuous Bag of Words)인 $P(o\|c)$가 있을 수 있고,
